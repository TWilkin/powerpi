...
describe("useRotateFloorplan", () => {
    ...
    test("rotation", async () => {
        ...
        await waitFor(() => {
            ...
            expect(result.current.floorplan.floors[0].rooms[0].width).toBeCloseTo(100);
            expect(result.current.floorplan.floors[0].rooms[0].height).toBeCloseTo(200);
            ...
            expect(result.current.floorplan.floors[1].rooms[0].width).toBeCloseTo(100);
            expect(result.current.floorplan.floors[1].rooms[0].height).toBeCloseTo(100);
            ...
            expect(result.current.floorplan.floors[1].rooms[1].width).toBeCloseTo(100);
            expect(result.current.floorplan.floors[1].rooms[1].height).toBeCloseTo(100);
