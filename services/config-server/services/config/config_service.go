...
func (service *configService) Parse(args []string) {
	...
	// GitHub flags
	flagSet.StringVar(&service.gitHub.UserId, "githubUser", "undefined", "The GitHub user id to authenticate as")
	flagSet.StringVar(&service.gitHub.TokenFile, "githubToken", "undefined", "The path to GitHub user token file to authenticate with")
